...
Page {
    ...
    Connections {
        ...
        function onStatisticsLoaded(data) {
            ...
            for(var i=0; i<data.length; i++) {
                if(data[i].revenue > max) max = data[i].revenue
            }
            root.maxRevenue = max > 0 ? max : 1
            if (chartCanvas.available) chartCanvas.requestPaint()
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Label {
                            ...
                            font.bold: true; font.pixelSize: 16; color: "black"
                            Layout.fillWidth: true
                        }
                        Button {
                    ...
                    Item {
                        ...
                        Canvas {
                            ...
                            onPaint: {
                                ...
                                var paddingTop = 30 // Увеличим отступ сверху для текста, чтобы влезла сумма
                                var maxH = h - paddingBottom

                                // Вычисляем ширину бара
                                ...
                                for (var i = 0; i < root.chartData.length; i++) {
                                    ...
                                    // Если продаж 0, рисуем маленькую полоску
                                    ...
                                    // --- ВЫВОД ТЕКСТА (КОЛИЧЕСТВО + СУММА) ---
                                    ctx.fillStyle = "#2c3e50"
                                    ctx.textAlign = "center"

                                    // Формируем строку: "5 (1200 ₽)"
                                    var label = item.count + " (" + item.revenue + " ₽)"

                                    // Адаптивный шрифт: если колонка узкая, уменьшаем шрифт
                    ...
                    RowLayout {
                        ...
                        ColumnLayout {
                            ...
                            Label {
                                ...
                                font.bold: true; color: "black"; font.pixelSize: 14
                            }

                            RowLayout {
                                Layout.fillWidth: true
                                Label { text: "Таблица:"; color: "black"; font.pixelSize: 14 }
                                ComboBox {
                                    id: tableSelector
                                    Layout.fillWidth: true
                        ...
                        ColumnLayout {
                            ...
                            Label {
                                ...
                                font.bold: true; color: "#c0392b"; font.pixelSize: 14
                            }

                            Item { Layout.fillHeight: true } // Толкает кнопки вниз

                            // Кнопка восстановления (ЗАГРУЗИТЬ)
                            Button {
    ...
    // Новый диалог для восстановления
    FileDialog {
        id: restoreDialog
        ...
        onAccepted: {
             ...
             // Вызов метода восстановления (убедитесь, что добавили его в DatabaseManager.cpp)
    ...
    Dialog {
        ...
        ColumnLayout {
            ...
            Label {
                ...
                Layout.alignment: Qt.AlignHCenter; Layout.topMargin: 15
            }
            Label {
                text: messageDialog.msgText
                wrapMode: Text.Wrap; horizontalAlignment: Text.AlignHCenter
                Layout.fillWidth: true; font.pixelSize: 14; color: "#2c3e50"; Layout.margins: 10
            }
            Item { Layout.fillHeight: true }
            Button {
                text: "OK"
                Layout.alignment: Qt.AlignHCenter; Layout.preferredWidth: 100; Layout.preferredHeight: 35; Layout.bottomMargin: 15
        ...
        function show(t, txt) { msgTitle = t; msgText = txt; open() }
    }
}
